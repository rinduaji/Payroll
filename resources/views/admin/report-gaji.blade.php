...
@section('title','Report & Export Gaji')
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" action="{{route('payroll.exportgaji')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-group">
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <label for="periode">Periode</label>
                                                <input type="text" class="form-control form-control-line" name="periode" id="periode">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="periode">Layanan</label>
                                                <input type="text" class="form-control form-control-line" name="layanan" id="layanan">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="periode">Area</label>
                                                <input type="text" class="form-control form-control-line" name="area" id="area">
                                            </div>
                                            <div class="col-md-2">
                                                <button class="form-control form-control-line btn btn-success text-white">
                                                    Export Excel
                                                </button>
                                            </div>
                                        </div>
